...
<head>
    ...
    <style>
        ...
        @media (max-width: 991.72px) {
            .header.site-header-detail .navigation-wrapper {
                z-index: 1000;
                padding: 12px 18px 24px;
                background: #ffffff;
            }

            .header.site-header-detail .navbar-nav {
                gap: 8px;
            }

            .header.site-header-detail .navbar-nav>li {
                display: block;
                padding: 0;
                overflow: hidden;
            }

            .header.site-header-detail .navbar-nav>li>a.nav-link {
                display: flex;
                align-items: center;
                justify-content: space-between;
                width: 100%;
            ...
            .header.site-header-detail .navbar-nav>li>a.dropdown-toggle::after {
                display: block;
                transition: transform 0.24s ease;
            }

            .header.site-header-detail .navbar-nav>li.mobile-dropdown-open>a.dropdown-toggle::after {
                transform: rotate(225deg);
                margin-bottom: -2px;
            }

            .header.site-header-detail .navbar-nav>li .dropdown-menu {
            ...
            .header.site-header-detail .navbar-nav>li.mobile-dropdown-open>.dropdown-menu {
                display: block;
            }

            .header.site-header-detail .dropdown-menu .row {
                display: block;
                margin: 0;
            }

            .header.site-header-detail .dropdown-menu [class*="col-"] {
                width: 100%;
                max-width: 100%;
                padding: 10px 0 0;
            }
            ...
            .header.site-header-detail .dropdown-menu .dropdown-header {
                padding: 10px 0 6px;
                font-size: 0.78rem;
            ...
            .header.site-header-detail .dropdown-menu .dropdown-item {
                padding: 10px 12px;
                border-radius: 6px;
                white-space: normal;
                line-height: 1.35;
            ...
            .header.site-header-detail .standard-menu {
                min-width: 0 !important;
            ...
            .header.site-header-detail .navbar-nav>li:last-child {
                border: 0;
                background: transparent;
                padding-top: 6px;
            }
...
<body class="node-type-blog page-id-209 path-node page-node-type-blog   d-flex flex-column h-100">
    ...
    <div class="dialog-off-canvas-main-canvas d-flex flex-column h-100" data-off-canvas-main-canvas>
        ...
        <header class="header site-header-detail">
        ...
        <script>
            (function () {
                var header = document.querySelector('.site-header-detail');
                if (!header) return;
