                                        ...
                                        <div class="blog-upper-content">
                                            <h2>
                                                <div
                                                    ...
                                                    Moments of Healing & Serenity</div>
                                            </h2>
                                            <div
                                                class="clearfix text-formatted field field--name-field-content field--type-text-long field--label-hidden field__item">
                                                <p>Explore our gallery to experience the tranquil spaces, healing
                                                    therapies, daily rituals, and natural surroundings of Saptarishi
                                                    Ayurveda Ashram, capturing the essence of holistic wellness and
                                                    mindful living.</p>
                                            </div>
                                        </div>
                                        ...
                                        <section class="long-lasting-benefits bg-light" id="gallery"
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="lasting-benefits-heading text-center "
                                                    ...
                                                    <h2 class="fw-bold">Watch Our Exclusive Environments and Work</h2>
                                                </div>
                                                <!-- Gallery Wrapper -->
                                            </div>
                                        </section>
                                        <div class="container" style="padding-bottom:100px;">
                                            <div class="wrapper row g-4">
                                                <!-- Gallery Item 1 -->
                                                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                                                    <div class="gallery-item overflow-hidden rounded-4 shadow-sm">
                                                        <img src="assets/emotional.jpg" alt="Retreat Space"
                                                ...
                                                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                                                    <div class="gallery-item overflow-hidden rounded-4 shadow-sm">
                                                        <img src="assets/mindfullness.jpg" alt="Meditation Session"
                                                            class=" w-100 gallery-img">
                                                    </div>
                                                </div>
                                                <!-- Gallery Item 3 -->
                                                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                                                    <div class="gallery-item overflow-hidden rounded-4 shadow-sm">
                                                        <img src="assets/emotional.jpg" alt="Nature Walk"
                                                            class=" w-100 gallery-img">
                                                    </div>
                                                </div>
                                                <!-- Gallery Item 4 -->
                                                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                                                    <div class="gallery-item overflow-hidden rounded-4 shadow-sm">
                                                        <img src="assets/mindfullness.jpg" alt="Group Workshop"
